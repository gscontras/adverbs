...
% \begin{itemize}
% \item Lots of stuff on adnominal superlatives.
% \item \citet{krasikova:2012}:
% ``One of the two remaining issues to be addressed is the
%   optionality of {\em the} in adverbial and predicative
%   superlatives.'' Predicative superlative:

% \ex. John is (the) smartest.

% {\footnotesize (cf.\ \citealt{matushansky:2008})}
...
\begin{frame}{{\em \textcolor{blue}{John}$_F$ \textcolor{purple}{climbed}
...
$\Rightarrow$ John climbed a higher mountain than anyone else.
\end{center}
...
\begin{frame}{{\em \textcolor{purple}{John climbed}
    the \textcolor{orange}{high}est \textcolor{ForestGreen}{mountain}
...
$\Rightarrow$ J.\ climbed a higher mountain on Tuesday than any other
day.
\end{center}
...
\begin{frame}{{\em \textcolor{blue}{John}$_F$ \textcolor{ForestGreen}{drove}
...
$\Rightarrow$ John's driving event is faster than anyone else's.
\end{center}
...
\begin{frame}{{\em John climbed the highest mountain}: Absolute reading}
...
$\Rightarrow$ John climbed Mt. Everest.
\end{center}
...
\begin{itemize}
\item Compare degrees/speeds:\\
The speed of John's running was greater than all other (relevant) speeds.
%John was the agent of running event $e$, and $e$ had a speed
 % that was greater than all other speeds in the context.
\item Compare events:\\
John's running event was faster than all other (relevant) running events.
%John was the agent of running event $e$, and $e$ was faster than
%  all other running events in the context.
\end{itemize}
\end{frame}


\begin{frame}{{\em John drove the fastest}: Absolute reading (I)}
...
$\Rightarrow$ John drove the fastest of the relevant speeds.
\end{center}
...
\begin{frame}{{\em John drove the fastest}: Absolute reading (II)}
...
$\Rightarrow$ John's driving was faster than all others' driving.
\end{center}
